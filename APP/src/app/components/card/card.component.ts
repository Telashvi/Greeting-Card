...
export class CardComponent implements OnInit {
  ...
  cardText: string ='אחל שנה טובה';
  selectedTextColor: string = '#2e2323'; // צבע טקסט דיפולטיבי
  selectedTextSize: Number = 1.3;
 ...
 ngAfterViewInit() {
  ...
  selectDefaultBackground() {
    this.selectedBackground = '/assets/images/Background3.jpg';
  }
...
onResize(event: MouseEvent) {
  ...
  this.selectedWidth = rect.width + 'px';
  this.selectedHeight = rect.height + 'px';
  this.selectedTop = rect.top + 'px';
  this.selectedLeft = rect.left + 'px';
}
